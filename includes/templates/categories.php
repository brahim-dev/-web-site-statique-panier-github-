				...
				<div class="pull-center">
					<ul class="header-top-links">
						...
						<li class="dropdown default-dropdown">
							...
							<ul class="custom-menu" style="width: 170px">
						...
						<li class="dropdown default-dropdown">
							...
							<ul class="custom-menu" style="width: 120px">
			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-logo">
						...
						<img src="layout/img/logo.png" alt="BAGA logo"> </a>
					</div>
					<!-- /Logo -->
								...
								<div class="row hidden-sm hidden-xs">
									<div class="col-md-12">
										...
										<a class="banner banner-1" href="products.php">
											<img src="layout/img/banners/banner05.jpg" alt="">
								...
								<div class="row">
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="products.php">
												<img src="layout/img/banners/banner06.jpg" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="products.php">
												<img src="layout/img/banners/banner07.jpg" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="products.php">
												<img src="layout/img/banners/banner08.jpg" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="products.php">
												<img src="layout/img/banners/banner09.jpg" alt="">
												<div class="banner-caption text-center">
